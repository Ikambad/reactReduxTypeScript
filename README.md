...
## Step 2: Start your Application and install node modules
...
### For iOS
Install pod first to run in iOS 
```bash
# using npm
cd ios
pod install
...
- Thanks to Code Step By Step to help me in understanding react redux easily, you can subscribe them from this link https://www.youtube.com/@codestepbystep 
